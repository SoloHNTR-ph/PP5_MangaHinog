...
<section class="container mt-5">
    <div class="row">
        <div class="col-md-3">
            <img src="./assets/Dragon Ball.jpg" class="img-fluid" alt="Manga Cover">
        </div>

        <div class="col-md-9 d-flex flex-column justify-content-between">
            <div class="mb-3">
                <h1 class="display-4 fw-bold">Dragon Ball</h1>
            </div>

            <div class="d-flex justify-content-between">
                <div>
                    <h5>Toriyama, Akira (Story), Toyotarou (Art)</h5>
                    <h5> Action, Comedy</h5>
                </div>
                <div>
                    <h5>Ongoing</h5>
            ...
            <div class="mt-4">
                <h5>Summary:</h5>
                <p>Having defeated Boo, Goku is starting to get bored with his life on Earth. His wife, Chi-chi, wants him to get a job, but all he wants to do is train and fight stronger enemies. Elsewhere in the universe, the God of Destruction, Beerus, and his attendant Whis are traveling from planet to planet in search of food and entertainment. After blowing up some hapless victims, Beerus is reminded of a man from his dreams with the moniker "Super Saiyan God," or something like that... The God of Destruction sets his sights on Earth to track down this mysterious man! Maybe this will give Goku something to do?</p>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-2 d-flex flex-column justify-content-center">
        ...
        <div class="container">
            ...
            <?php if (isset($_SESSION['username'])): ?>
                <form action="manga2.php" method="POST">
