...
<section class="container mt-5">
    <div class="row">
        <div class="col-md-3">
            <img src="./assets/Chainsaw Man.jpg" class="img-fluid" alt="Manga Cover">
        </div>

        <div class="col-md-9 d-flex flex-column justify-content-between">
            <div class="mb-3">
                <h1 class="display-4 fw-bold">Chainsaw Man</h1>
            </div>

            <div class="d-flex justify-content-between">
                <div>
                    <h5> Fujimoto, Tatsuki</h5>
                    <h5>Action, Award Winning, Supernatural</h5>
                </div>
                <div>
                    <h5>Ongoing</h5>
                </div>
    ...
    <div class="container mt-2 d-flex flex-column justify-content-center">
        ...
        <div class="container">
            ...
            <?php if (isset($_SESSION['username'])): ?>
                <form action="manga6.php" method="POST">
